                ...
                <div class="space-y-4 text-sm text-slate-700 font-gujarati">
                    ...
                    <div class="pt-4 border-t border-slate-100">
                        <a href="https://wa.me/919876543210" target="_blank"
                            class="inline-flex items-center gap-2 px-5 py-3 bg-emerald-600 hover:bg-emerald-700 text-white font-bold rounded-xl shadow-md transition-all text-xs font-gujarati">
