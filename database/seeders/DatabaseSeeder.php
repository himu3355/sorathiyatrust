...
class DatabaseSeeder extends Seeder
{
    public function run(): void
    {
        ...
        // Sliders
        Slider::create([
            'title' => 'શ્રી દશા સોરાઠિયા વાણિયા સમાજ (મહાજન), રાજકોટ',
        ...
        News::create([
            ...
            'content' => '<p>શ્રી દશા સોરાઠિયા વાણિયા સમાજ દ્વારા દર વર્ષની જેમ આ વર્ષે પણ શૈક્ષણિક વર્ષ ૨૦૨૫-૨૬ ના તેજસ્વી તારલાઓનું સન્માન કરવાનો નિર્ણય લેવામાં આવ્યો છે. તમામ વિદ્યાર્થીઓએ પોતાના ગુણપત્રક કાર્યાલય ખાતે જમા કરાવવાના રહેશે.</p>',
            'published_at' => now(),
            'is_featured' => true,
            'is_active' => true,
        ]);
        News::create([
            ...
            'content' => '<p>રાજકોટ સ્થિત શ્રી દશા સોરાઠિયા વાણિયા સમાજ મહાજન વાડીનું નવીનીકરણ કાર્ય સફળતાપૂર્વક પૂર્ણ થયું છે. તમામ સભ્યો પ્રસંગો માટે બુકિંગ કરાવી શકશે.</p>',
